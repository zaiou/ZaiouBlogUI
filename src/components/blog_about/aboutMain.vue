<template>
    <div class="layui-tab-content">
        <div class="layui-tab-item">
            <div class="aboutinfo">
                <div class="aboutinfo-figure">
                    <img src="../../assets/images/Logo_100.png" alt="不落阁" />
                </div>
        ...
        <div class="layui-tab-item">
            <div class="aboutinfo">
                <div class="aboutinfo-figure">
                    <img src="../../assets/images/Absolutely.jpg" alt="Absolutely" />
                </div>
        ...
        <div class="layui-tab-item">
            <div class="aboutinfo">
                <div class="aboutinfo-figure">
                    <img src="../../assets/images/handshake.png" alt="友情链接" />
                </div>
                        ...
                        <ul class="friendlink">
                            ...
                            <li>
                                <a target="_blank" href="http://www.pagemark.cn/" title="页签" class="friendlink-item">
                                    <p class="friendlink-item-pic"><img src="http://www.layui.com/favicon.ico" alt="页签" /></p>
                            ...
                            <ul class="blog-comment">
                                <li>
                                    <div class="comment-parent">
                                        <img src="../../assets/images/Logo_40.png" alt="不落阁" />
                                        <div class="info">
