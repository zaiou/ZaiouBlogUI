...
export default {
  ...
  mounted(){
      console.log("获取用户数据设置成全局变量，测试vuex");
...
.bdsharebuttonbox {
    ...
    .bdsharebuttonbox .bds_qzone {
        background: url(assets/images/qzone_32.png) no-repeat;
    }

    .bdsharebuttonbox .bds_tsina {
        background: url(assets/images/weibo_32.png) no-repeat;
    }

    .bdsharebuttonbox .bds_weixin {
        background: url(assets/images/wechat_32.png) no-repeat;
    }

    .bdsharebuttonbox .bds_sqq {
        background: url(assets/images/qq_32.png) no-repeat;
    }
